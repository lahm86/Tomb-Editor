...
namespace TombLib.LevelData.Compilers.TombEngine
{
    public sealed partial class LevelCompilerTombEngine : LevelCompiler
    {
        ...
        {
            var collection = PropertyCollector.Generate(_level);
            if (collection == null)
            {
            ...
            _luaPropertyScriptBlob = LuaPropertyScriptBuilder.BuildFullPropertyScript(collection.GlobalMoveables, collection.GlobalStatics, collection.Moveables, collection.Statics);
        }
